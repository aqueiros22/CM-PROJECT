                    ...
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        Icon(
                            if (searchQuery.isEmpty()) {
                                if (showArchived) Icons.Default.Inventory2 else Icons.Default.LocationOn
                ...
                LazyColumn(
                    ...
                    items(filteredVisits) { visit ->
                        VisitCard(
                            ...
                            onArchive = { visitViewModel.archiveVisit(visit) },
                            onRestore = { visitViewModel.unarchiveVisit(visit) },
