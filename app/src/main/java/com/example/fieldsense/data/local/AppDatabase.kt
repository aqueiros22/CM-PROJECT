...
@Database(entities = [Visit::class, Note::class, Attachment::class, Template::class, Question::class, VisitChecklist::class, Answer::class, Area::class ], version = 10, exportSchema = false)
